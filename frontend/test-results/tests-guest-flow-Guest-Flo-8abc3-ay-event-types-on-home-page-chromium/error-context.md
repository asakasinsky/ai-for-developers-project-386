...
- Name: tests/guest-flow.spec.ts >> Guest Flow >> should display event types on home page
- Location: e2e/tests/guest-flow.spec.ts:31:3
...
Locator: locator('h1')
Expected substring: "Book a Meeting"
Timeout: 5000ms
